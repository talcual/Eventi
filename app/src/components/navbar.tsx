                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><NavLink className="dropdown-item" to="/products/popular">Popular Items</NavLink></li>
                                    <li><NavLink className="dropdown-item" to="/products/new">New Arrivals</NavLink></li>
                                </ul>
                            </li>
                        </ul>
